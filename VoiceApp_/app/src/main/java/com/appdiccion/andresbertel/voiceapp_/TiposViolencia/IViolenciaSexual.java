...
import com.appdiccion.andresbertel.voiceapp_.RutasdeAtencion.RutaSexual;
import com.appdiccion.andresbertel.voiceapp_.intefaz_contacto;

public class IViolenciaSexual extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iviolencia_sexual);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent ir = new Intent(IViolenciaSexual.this, RutaSexual.class);
                startActivity(ir);
            }
        });
