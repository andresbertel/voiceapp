...
import com.appdiccion.andresbertel.voiceapp_.TiposdeViolencia;
import com.appdiccion.andresbertel.voiceapp_.intefaz_contacto;

public class IViolenciaFisica extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iviolencia_fisica);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent ir = new Intent(IViolenciaFisica.this, RutaFisica.class);
                startActivity(ir);
            }
        });
